...
def train(opt):
    ...
    train_dataset = CustomDataset(train_img_path, train_label_path, augment=True, hyp=hyp, radam_perspect=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='yolov5s_pretrain.pth', help='pretrained model')
